...
# CMD su - non-root -c "cd /home/non-root/MaskinProgrammering03/OSELAS.BSP-EnergyMicro-Gecko && sh TDT4258_helper_scripts/ptxdist_rebuild_flash_game.sh"

# RUN su - non-root -c "cat >> v/home/non-root/MaskinProgrammering04/OSELAS.BSP-EnergyMicro-Gecko && sh TDT4258_helper_scripts/ptxdist_rebuild_flash_driver.sh && sh TDT4258_helper_scripts/ptxdist_rebuild_flash_driver.sh"
